            ...
            <div className="flex items-center justify-between mt-3">
              ...
              <Sheet open={sheetIsOpen} onOpenChange={setSheetIsOpen}>
                ...
                <SheetContent className="p-0 ">
                  <SheetHeader className="text-left w-[600px] px-5 py-6 border-b border-solid border-secondary">
                  ...
                  <div className="px-5 my-2">
                    {date && (
                      <div className="flex gap-3  overflow-x-auto py-5 px-5 border-t border-solid border-secondary ">
                        {timeList.map((time) => (
                          <Button
